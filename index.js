...
//console.log("b. ", false)
//console.log("c. ", true)
//console.log("d. ", bolean)

// 2. o valor recebido como resposta no prompt é um texto. No console, serão impressos dois números agrupados e não somados.

// 3.  para que os dois números sejam somados, é necessário utilizar a função Number() para converter o valor obtido no prompt para número.

// B. - 1 Exercícios de escrita de código
